<template>
  <v-container class="container--fluid grid-list-md">
    <v-row no-gutters>
      <v-col cols="12">
        <v-alert :value="true" color="info" outlined dense>
          ...
          <a class="link-type" href="//github.com/kazupon/vue-i18n">vue-i18n</a>
        </v-alert>
      </v-col>

      <v-col md="4" offset-md="4" sm="8" offset-sm="2" cols="12">
        <app-widget :title="$t('ui.switch')" class="text-center" icon="mdi-translate" padding-hide>
          <div slot="widget-content">
            <v-list v-for="item in locales" :key="item.abbr">
              <v-list-item ripple="ripple" :target="item.target" @click="setLocale(item.locale)">
                <v-list-item-action>
    ...
    <v-row align="center">
      ...
      <v-col cols="12" sm="8" offset-sm="2" class="text-center d-md-flex">
        <v-col cols="12" md="4">
