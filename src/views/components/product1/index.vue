              ...
              <v-col cols="12" md="6" class="pt-0">
                ...
                <v-row >
                  <v-col v-for="product in item.products" :key="product" cols="12">
                    <v-alert class="pa-2 d-flex justify-center gold ma-0 outlined" border="left" v-bind="attrs" v-on="on">
                ...
                <v-container>
                <v-row>
                   <v-form class="" ref="form" max-width="800" width="100%"  v-model="valid" lazy-validation>
                      <v-text-field
                        v-model="name"
                        :counter="10"
                        :rules="nameRules"
