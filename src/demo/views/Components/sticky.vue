<template>
  <v-container class="container--fluid grid-list-md">
    <v-row class="overflow-hidden" style="position: relative;">
      <v-col cols="12">
        <sticky :z-index="1000000">
          ...
          >
            ...
            <v-col cols="4">
              <v-autocomplete :items="items" label="Box style" />
            </v-col>
      ...
      <v-col class="flex-grow-1 components-container" cols="12">
