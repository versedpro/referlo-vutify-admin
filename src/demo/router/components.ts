...
const componentsRouter = [
  {
    ...
    children: [
      {
        path: "tinymce",
        component: () => import("@/demo/views/Components/tinymce.vue"),
        name: "TinymceDemo",
        meta: { title: "route.component.tinymce" }
      },
      {
        path: "markdown",
        component: () => import("@/demo/views/Components/markdown.vue"),
        name: "MarkdownDemo",
        meta: { title: "route.component.markdown" }
      },
      {
        path: "json-editor",
        component: () => import("@/demo/views/Components/jsonEditor.vue"),
        name: "JsonEditorDemo",
        meta: { title: "route.component.jsonEditor" }
      },
      {
        path: "splitpane",
        component: () => import("@/demo/views/Components/splitpane.vue"),
        name: "SplitpaneDemo",
        meta: { title: "route.component.splitPane" }
      },
      {
        path: "dropzone",
        component: () => import("@/demo/views/Components/dropzone.vue"),
        name: "DropzoneDemo",
        meta: { title: "route.component.dropzone" }
      },
      {
        path: "sticky",
        component: () => import("@/demo/views/Components/sticky.vue"),
        name: "StickyDemo",
        meta: { title: "route.component.sticky" }
      },
      {
        path: "count-to",
        component: () => import("@/demo/views/Components/countTo.vue"),
        name: "CountToDemo",
        meta: { title: "route.component.countTo" }
      },
      {
        path: "back-to-top",
        component: () => import("@/demo/views/Components/backToTop.vue"),
        name: "BackToTopDemo",
        meta: { title: "route.component.backToTop" }
      },
      {
        path: "drag-kanban",
        component: () => import("@/demo/views/Components/dragKanban.vue"),
        name: "DragKanbanDemo",
